...
Minio: 4445 ГБ (фото в компаниях) + 406 Гб (фото в вакансиях) + 7724 Гб (фото пользователей) + 11000 Гб (фото резюме) = 23575 Гб
...
Сервер iRU Rock g2212ag4, 2U 2146473 [^26] (1700000 руб):
* 64 CPU
* 256 Гб ОЗУ + 4 плашки по 32 Гб [^28] (4 * 50000 руб = 200000 руб)
* Используя RAID 5, возьмем 4 SSD (1 отнимает RAID 5) по 12 Тб [^27] = 36 Тб (320000 руб * 4 = 1280000 руб)
* Итого: 3200000 руб

На каждый ДЦ возьмем по 2 таких сервера: 3200000 * (2 * 3 + 1 (резервирование в случае отказа)) = 22 400 000 руб

Для резервирования SSd в случае поломки берем еще 2 SSD: 320000 * 2 = 640000 руб

Итого: 22 400 000 руб + 640 000 руб = 23100000 руб
