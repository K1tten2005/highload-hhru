...
- Новосибирск
  - Датацентр в Ноосибирске нужен, чтобы снизить задержку для пользователей за Уралом и обеспечить географическую отказоустойчивость, а также обуспечить приемлемые условия пользования сайтом для жителей Дальнего Востока
