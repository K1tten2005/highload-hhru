...
Расчет rps:
- 2,1 млн DAU * 59 (действия пользователей) / (60 * 60 * 24) = 1434 rps
...
| Действие                    | RPS | RPS в пик | Сеть пик | Сеть в день |
|-----------------------------|-----|-----------|----------|-------------|
| Авторизация                 | 0,03 | |
| Регистрация                 | 0,02 | | 
| Просмотр вакансий           | 44 | | 
| Поиск вакансий              | 13 | |
| Публикация вакансий         | 0,001 | |
| Закрытие вакансии           | 0,003 | |
| Отклик на вакансию          | 0,2 | | 
| Ответ на отклик на вакансию | 0,2 | | 
| Использование чата          | 1,7 | | 
| Создание резюме             | 0,16 | | 
