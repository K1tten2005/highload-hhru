...
## 11. Список сереров
На 1 ядро - 50 rps для простой логики. Для сложной 20 rps
...
| Действие         | Пиковый RPS (x2) | Тип бизнес-логики | CPU               | RAM, ГБ           |
| -------------- | ---------------- | ------------------| ----------------- | ----------------- | 
| Авторизация           | 1,4       | средняя            | 1                 | 0,5               |
...
| Cоздание резюме          | 0,006    | тяжёлая           | 1                 | 1               |
